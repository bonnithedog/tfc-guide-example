...
mkdir -p ~/downloads
cd ~/downloads
wget -nc http://prdownloads.sourceforge.net/sourceforge/nagios/nagios-4.4.3.tar.gz
wget -nc https://nagios-plugins.org/download/nagios-plugins-2.2.1.tar.gz
wget -nc http://sourceforge.net/projects/nagiosgraph/files/nagiosgraph/1.4.4/nagiosgraph-1.4.4.tar.gz
wget -nc https://downloads.sourceforge.net/project/nconf/nconf/1.3.0-0/nconf-1.3.0-0.tgz?r=https%3A%2F%2Fsourceforge.net%2Fprojects%2Fnconf%2Ffiles%2Flatest%2Fdownload&ts=1551472556
...
sudo sed -i "s:^service_perfdata_file.4.4.3:g" /usr/local/nagios/etc/nagios.cfg
sudo sed -i "s:^host_perfdata_file.4.4.3:g" /usr/local/nagios/etc/nagios.cfg
